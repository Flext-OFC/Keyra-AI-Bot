...
let biografia = await conn.fetchStatus('1130182250' +'@s.whatsapp.net').catch(_ => 'Sin Biografía')
...
let name = await conn.getName(who)
  ...
  await sendContactArray(conn, m.chat, [
     [`${nomorown}`, `👑 Propietario`, `𝑭𝑳𝑬𝑿𝑻-𝑶𝑭𝑪`, dev, correo, `🇦🇷 Argentina`, `${global.yt}`, bio],
[`${conn.user.jid.split('@')[0]}`, `Es Una Bot 🍟`, `${packname}`, `📵 No Hacer Spam`, correo, `🇦🇷 Argentina`, md, biobot]
], m)
